...
function xmldb_attendance_upgrade($oldversion=0) {
    ...
    if ($oldversion < 2023021600) {
        ...
        // Define field studentavailability to be added to attendance_statuses.
        $table = new xmldb_table('attendance_statuses');
        $field = new xmldb_field('allowupdatestatus', XMLDB_TYPE_INTEGER, '10', null, null, null, null, 'availablebeforesession');
        ...
        // Attendance savepoint reached.
        upgrade_mod_savepoint(true, 2023021600, 'attendance');
    }
